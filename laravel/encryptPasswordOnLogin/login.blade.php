    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('login') }}" onSubmit="return LoginEncrypter(this)">
                    @csrf
                    <div class="input-group mb-3">
                        <input id="username" type="username" class="form-control @error('email') is-invalid @enderror" name="username"
